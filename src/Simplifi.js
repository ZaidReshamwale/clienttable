...
let data = 
 [
    ...
    const [market,setMarket] = useState([]);
        ...
        try{
             var clienta = data.filter( element => element. id == "28185506");
 console.log(clienta);
 ...
 useEffect(() => {
	...
	return (
 <table id="Simplifi"
                                                            class="table  table-hover table-responsive-sm no-gutters "
                                                            style={{width:'100%'}}>
                                                            <thead class="table-secondary text-dark ">
                                                                <tr>

                                                                    <th style= {{width:'40%'}}><u>SIMPLIFI  </u></th>
                            ...
                            {market.map(item => (
                                <tr  className="">
                                    ...
                                    <td>{item.cost_budget}</td>
                                    <td > {item.budget_spent} </td>
                                <td>{item.money_budget_left_percentage}</td>
